...
def fetch_all_companies(query):
    ...
    while True:
        ...
        if data and 'items' in data:
            ...
            # Check if there are more companies by comparing the number of companies
            if len(data['items']) < items_per_page:
                break
            start_index += items_per_page  # Move to the next set of results
        else:
            break
